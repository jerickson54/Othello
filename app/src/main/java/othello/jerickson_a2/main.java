...
public class main extends AppCompatActivity {
    ...
    public static Intent newIntentToOptions(Context packageContext, int numWinsBlack, int numWinsWhite, boolean whoIsFirst){
    ...
    public static Intent newIntentToGame(Context packageContext, int numWinsBlack, int numWinsWhite, boolean whoIsFirst){

        Intent intent = new Intent(packageContext,othello.class);
        intent.putExtra(NUM_WINS_BLACK,numWinsBlack);
        intent.putExtra(NUM_WINS_WHITE,numWinsWhite);
        intent.putExtra(WHO_IS_FIRST,whoIsFirst);
        return intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(blackFirst)
            Log.i("PASSED TO: ","true");
        else
            Log.i("PASSED TO: ", "false");
